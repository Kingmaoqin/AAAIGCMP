"""
Experiments for multiple continuous treatments
"""
...
def run_multi_continuous_experiments():
    """Run all experiments for multiple continuous treatments"""
    # Set random seeds
    torch.manual_seed(42)
    np.random.seed(42)
    
    # Initialize framework with custom directory
    framework = GCMPTuningFramework(base_dir='./tuning_results_multi_continuous')
...
if __name__ == "__main__":
    run_multi_continuous_experiments()