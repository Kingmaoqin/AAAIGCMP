"""
Experiments for multiple binary treatments
"""
...
def run_multi_binary_experiments():
    """Run all experiments for multiple binary treatments"""
    # Set random seeds
    torch.manual_seed(42)
    np.random.seed(42)
    
    # Initialize framework with custom directory
    framework = GCMPTuningFramework(base_dir='./tuning_results_multi_binary')
    
    treatment_type = 'multi_binary'
